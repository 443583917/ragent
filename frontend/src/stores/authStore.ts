...
import { getCurrentUser, login as loginRequest, register as registerRequest, logout as logoutRequest } from "@/services/authService";
  ...
  register: async (username, password) => {
    ...
    try {
      ...
      useChatStore.setState({
        ...
        isLoading: false, isStreaming: false, isCreatingNew: true,
        deepThinkingEnabled: false, thinkingStartAt: null,
        streamTaskId: null, streamAbort: null, streamingMessageId: null,
        cancelRequested: false
      });
