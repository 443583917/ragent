...
func NewMultiChannelEngine(channels []SearchChannel, postProcessors []PostProcessor) *MultiChannelEngine {
	// 按优先级排序
...
func (e *MultiChannelEngine) RetrieveKnowledgeChannels(ctx context.Context, sc *SearchContext) ([]RetrievedChunk, error) {
	// 阶段 1：筛选启用通道 → 并行执行
...
func (e *MultiChannelEngine) executeChannels(ctx context.Context, sc *SearchContext) []*ChannelResult {
...
func (e *MultiChannelEngine) executePostProcessors(ctx context.Context, chunks []RetrievedChunk, sc *SearchContext) []RetrievedChunk {
...
func mergeChunks(results []*ChannelResult) []RetrievedChunk {
