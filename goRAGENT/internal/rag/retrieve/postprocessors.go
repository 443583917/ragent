...
type PostProcessor interface {
	...
	Process(ctx context.Context, chunks []RetrievedChunk, sc *SearchContext) ([]RetrievedChunk, error)
}
...
func (d *DedupPostProcessor) IsEnabled(ctx context.Context, sc *SearchContext) bool {
	return true
}

func (d *DedupPostProcessor) Process(ctx context.Context, chunks []RetrievedChunk, sc *SearchContext) ([]RetrievedChunk, error) {
...
func (f *FusionPostProcessor) IsEnabled(ctx context.Context, sc *SearchContext) bool {
	return true
}

func (f *FusionPostProcessor) Process(ctx context.Context, chunks []RetrievedChunk, sc *SearchContext) ([]RetrievedChunk, error) {
	k := f.RRFK
	if k <= 0 {
		k = 60
	}
...
func (r *RerankPostProcessor) IsEnabled(ctx context.Context, sc *SearchContext) bool {
	return r.enabled && r.reranker != nil
}

func (r *RerankPostProcessor) Process(ctx context.Context, chunks []RetrievedChunk, sc *SearchContext) ([]RetrievedChunk, error) {
